...
import com.ueniweb.swiftwaresolutions.data.ENTCaseSheetData;
import org.springframework.jdbc.core.RowMapper;

import java.sql.ResultSet;
import java.sql.SQLException;

public class ENTCaseSheetRowMapper implements RowMapper<ENTCaseSheetData> {

    private final String schema;

    private final String tableSchema;

    public ENTCaseSheetRowMapper() {

        final StringBuilder tableBuilder = new StringBuilder();
        tableBuilder.append(" FROM cli_patient_ent_casesheet cs ");
    ...
    @Override
    public ENTCaseSheetData mapRow(ResultSet rs, int i) throws SQLException {
        ...
        return ENTCaseSheetData.newInstance(id, patId, vstId, ipId, consultantId, dateTime, presentIllness, pastHistory, allergy,
