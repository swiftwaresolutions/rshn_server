...
public class LabOrderTemplateRowMapper implements RowMapper<LabTestNameData> {


    private final String schema;

    public LabOrderTemplateRowMapper(){
        final StringBuilder builder = new StringBuilder(200);
        builder.append("FROM lab_config_master_dept a2,lab_config_master_test a1,cli_investigation_template_details a3 ");
    ...
    public String tableSchema() {
        ...
        builder.append("a3.procedureRate AS rate, ");
        builder.append("a1.charity,");
