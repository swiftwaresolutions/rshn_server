...
public class ENTCaseSheetData {
    ...
    public ENTCaseSheetData(Long id, Long patId, Long vstId, Long ipId, Long consultantId, String dateTime, String presentIllness, String pastHistory,
    ...
    public static ENTCaseSheetData newInstance(Long id, Long patId, Long vstId, Long ipId, Long consultantId,String dateTime, String presentIllness,
        ...
        return new ENTCaseSheetData (id, patId, vstId, ipId, consultantId, dateTime, presentIllness, pastHistory, allergy, temperature, pulse, rr, bp,
