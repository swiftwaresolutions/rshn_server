...
@Data
public class OpthamologyCaseSheetData {
    ...
    public OpthamologyCaseSheetData(Long id, Long patId, Long vstId, Long ipId, Long consultantId, String dateTime, String presentIllness, String pastHistory,
    ...
    public static OpthamologyCaseSheetData newInstance(Long id, Long patId, Long vstId, Long ipId, Long consultantId,String dateTime, String presentIllness,
        ...
        return new OpthamologyCaseSheetData (id, patId, vstId, ipId, consultantId, dateTime, presentIllness, pastHistory, allergy, temperature, pulse, rr, bp,
