...
import com.ueniweb.swiftwaresolutions.data.DermatologyCaseSheetData;
import org.springframework.jdbc.core.RowMapper;

import java.sql.ResultSet;
import java.sql.SQLException;

public class DermatologyCaseSheetRowMapper implements RowMapper<DermatologyCaseSheetData> {

    private final String schema;

    private final String tableSchema;

    public DermatologyCaseSheetRowMapper() {

        final StringBuilder tableBuilder = new StringBuilder();
        tableBuilder.append(" FROM cli_patient_dermatology_casesheet cs ");
    ...
    @Override
    public DermatologyCaseSheetData mapRow(ResultSet rs, int i) throws SQLException {
        ...
        return DermatologyCaseSheetData.newInstance(id, patId, vstId, ipId, consultantId, dateTime, presentIllness, pastHistory, allergy,
